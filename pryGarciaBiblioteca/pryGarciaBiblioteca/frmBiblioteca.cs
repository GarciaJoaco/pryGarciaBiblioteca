...
namespace pryGarciaBiblioteca
{
    public partial class frmBiblioteca : Form
    {
        ...
        {
            NumPag--;// //la Resta de la  pagina va afuera del if para que no se acumule "Retroseder " 
            if (NumPag >= 0)
            {
            ...
            else
            {
                ...
                NumPag = 0;// no deja que baje mas de sero 
            }
        }
        ...
        private void frmBiblioteca_Load(object sender, EventArgs e)
        {
            ...
            {
                string[] arrayDistribuidora = srDistribuidora.ReadLine().Split(separador);// crea un vector por cada coma 
            ...
            {
                string[] arrayEditorial = srEditorial.ReadLine().Split(separador);// lee y lo pone en editorial
            ...
            while (!srConsultaLibro.EndOfStream)
            {
                ...
                switch (matConsultaLibro[fm, 4])// switch nos permite evaluar una variable y realizar diferentes cosas según el resultado de la evaluación
                    //Segun el numero que tenga la matriz, va a ser el que se ponga en la  matriz
                {
                ...
                {
                    case "\t1": matConsultaLibro[fm, 2] = matEditorial[0, 1]; break;// lo lee y lo  agrega a la matriz 
                    case "\t2": matConsultaLibro[fm, 2] = matEditorial[1, 1]; break;
                    case "\t3": matConsultaLibro[fm, 2] = matEditorial[2, 1]; break;// break transfiere el control a la instrucción que hay a continuación de la instrucción finalizada, si existe.
            ...
            srConsultaLibro.Close();//Muestra la pimera fila de la matriz en la grilla
            dgvConsultaLibros.Rows.Add(matConsultaLibro[NumPag, 0],
            matConsultaLibro[NumPag, 1],
            matConsultaLibro[NumPag, 2],
            matConsultaLibro[NumPag, 3],
        ...
        private void btnSiguiente_Click(object sender, EventArgs e)
        {
            ...
            if (NumPag < 21)//Esta avansa hacia adelante 
            {
                dgvConsultaLibros.Rows.Clear();
                dgvConsultaLibros.Rows.Add(matConsultaLibro[NumPag, 0],
                   matConsultaLibro[NumPag, 1],
            ...
            {
                MessageBox.Show("No hay mas datos que mostrar");
                NumPag = 20;// no deja que se pase  mas de 20
            }
        }
    }
}
